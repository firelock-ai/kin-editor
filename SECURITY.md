...
1. Go to the **Security** tab of [firelock-ai/kin-editor](https://github.com/firelock-ai/kin-editor/security).
...
This policy covers the `kin-editor` repository: the Kin VS Code extension
